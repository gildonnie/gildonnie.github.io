              ...
              <div className={` md:flex md:items-center ${isMenuOpen ? 'flex ' : 'hidden'}`}>
                ...
                <div className=" md:block">
                  <a
                    ...
                    href="https://docs.google.com/document/d/1EVHGxKpgDHXireyLwlH081byFwJFG9W5/edit?usp=sharing&ouid=102567614860551222590&rtpof=true&sd=true" target="_blank" rel="noreferrer" 
                  >
                    Resume
                  </a>
                </div>
