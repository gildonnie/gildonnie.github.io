      ...
      <main className="bg-slate-400 dark:bg-gray-800 static">
        ...
        <section className="h-screen px-10 md:px-20 lg:px-40">
          <nav className="py-4 mb-12  flex justify-between">
            <a className="cursor-pointer">{!darkMode ? <Image src={Dlogo} alt="nav-logo" width={130} height={130} className="w-20 md:w-30 dark:text-slate-100" /> : <Image src={DlogoDmode} alt="nav-logo" width={130} height={130} className="w-20 md:w-30 dark:text-slate-100" />}</a>
            <div>
              <ul className="flex pt-7 font-normal text-slate-700 dark:text-slate-400">
                ...
                <li>
                  <a className="mr-8" href="#web">Web Developer Projects</a>
                </li>
                <li>
                  <a className="mr-8" href="#data">Data Analyst Projects</a>
                </li>
              </ul>
            </div>
            <ul className="flex items-center">
              <li>{!darkMode ? <BsFillMoonStarsFill className="cursor-pointer text-2xl hover:text-slate-800 dark:text-slate-400" onClick={() => setDarkMode(!darkMode)}/> : <BsFillSunFill className=" cursor-pointer text-2xl dark:text-slate-200 dark:hover:text-slate-300" onClick={() => setDarkMode(!darkMode)}/>}</li>
              <li>
                <a 
                  className=" bg-slate-500 text-slate-300 px-4 py-1 rounded-xl ml-8 hover:bg-slate-300 hover:text-slate-500 dark:bg-slate-700 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-slate-800" href="#">Resume
                </a>
              </li>
            </ul>
          </nav>
        ...
        <section className="md:mb-60 md:-mt-5 px-10 md:px-20 lg:px-40 lg:-mt-5 ">
         ...
         <div>
          ...
          <div className="md:flex gap-10 md:justify-center">
            ...
            >
              <Image src={Logo} alt="project-images" width={100} height={100} className="inline"/>
            ...
            <div className="bg-slate-300 text-center shadow-md shadow-slate-600 p-10 rounded-lg my-10 lg:max-w-md dark:shadow-gray-900 dark:shadow-lg dark:bg-gray-700">
              ...
              <div className="flex justify-center">
                <a className="mr-5 text-2xl hover:text-slate-700 dark:hover:text-slate-500" href="https://gildonnie.github.io/weather-app/" target="_blank" rel="noreferrer"><MdOutlineWebAsset /></a>
                <a className="text-2xl hover:text-slate-700 dark:hover:text-slate-500" href="https://github.com/gildonnie/capstone-nasa-appp" target="_blank" rel="noreferrer"><AiFillGithub /></a>
              </div>
              <h4 className="py-4 text-slate-800 dark:text-slate-500">Technologies used</h4>
              <p className="text-slate-600 py-1 dark:text-slate-400">ReactJs</p>
