...
export default function Home() {
  ...
  return (
    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      {!isMenuOpen ? <GiHamburgerMenu onClick={toggleMenu} className="text-3xl hover:cursor-pointer dark:text-slate-400" /> : <div className="text-2xl border-2 border-slate-500 w-8 text-center bg-slate-600 text-slate-400 hover:cursor-pointer ml-20" onClick={toggleMenu}>X</div>}
      </div>
      ...
      <div className={` md:flex md:items-center ${isMenuOpen ? 'flex' : 'hidden'}`}>
        <ul className="navBar flex pt-7 font-normal text-slate-700 dark:text-slate-400">
          <li className="mr-10 hover:cursor-pointer"  onClick={() => {
